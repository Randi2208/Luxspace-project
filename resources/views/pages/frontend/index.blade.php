            ...
            <div class="container mx-auto">
              ...
              <div class="grid grid-rows-2 grid-cols-9 gap-4">
                ...
                >
                  ...
                  <a href="{{ route('details', ['slug' => 'ads']) }}" class="stretched-link">
                    <!-- fake children -->
                  </a>
                </div>
                <div
          ...
          <section class="flex flex-col py-16">
            ...
            <div class="overflow-x-hidden px-4" id="carousel">
              ...
              <div class="flex -mx-4 flex-row relative">
                ...
                {{--lakukan perulangan untuk memunculkan product--}}
                ...
                <div class="px-4 relative card group">
                  ...
                  >
                    ...
                    <img
                    {{--jika pada product gallerinya ada maka akan menampilkan gambar pertama jika tidak ada akan menampilkan warna abu--}}
